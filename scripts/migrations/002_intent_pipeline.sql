-- Migration: Intent Lead Pipeline and Deal Matching System
-- Created: 2026-06-26
...
CREATE INDEX idx_scan_runs_source ON source_scan_runs(source_config_id);
CREATE INDEX idx_scan_runs_status ON source_scan_runs(status);
CREATE INDEX idx_scan_runs_created ON source_scan_runs(created_at DESC);
...
CREATE INDEX idx_intent_leads_source ON intent_leads(source_config_id);
CREATE INDEX idx_intent_leads_status ON intent_leads(status);
CREATE INDEX idx_intent_leads_category ON intent_leads(service_category);
CREATE INDEX idx_intent_leads_location ON intent_leads(location_text);
CREATE INDEX idx_intent_leads_urgency ON intent_leads(urgency);
CREATE INDEX idx_intent_leads_confidence ON intent_leads(confidence_score DESC);
CREATE INDEX idx_intent_leads_created ON intent_leads(created_at DESC);
...
CREATE INDEX idx_intent_lead_events_lead ON intent_lead_events(intent_lead_id);
CREATE INDEX idx_intent_lead_events_type ON intent_lead_events(event_type);
CREATE INDEX idx_intent_lead_events_created ON intent_lead_events(created_at DESC);
...
CREATE INDEX idx_deal_matches_lead ON deal_matches(intent_lead_id);
CREATE INDEX idx_deal_matches_provider ON deal_matches(provider_id);
CREATE INDEX idx_deal_matches_status ON deal_matches(status);
CREATE INDEX idx_deal_matches_score ON deal_matches(match_score DESC);
CREATE INDEX idx_deal_matches_created ON deal_matches(created_at DESC);
...
CREATE INDEX idx_deal_match_scripts_match ON deal_match_scripts(deal_match_id);
CREATE INDEX idx_deal_match_scripts_type ON deal_match_scripts(script_type);
...
CREATE INDEX idx_deal_match_events_match ON deal_match_events(deal_match_id);
CREATE INDEX idx_deal_match_events_type ON deal_match_events(event_type);
CREATE INDEX idx_deal_match_events_created ON deal_match_events(created_at DESC);
...
CREATE INDEX idx_agent_loop_runs_type ON agent_loop_runs(loop_type);
CREATE INDEX idx_agent_loop_runs_status ON agent_loop_runs(status);
CREATE INDEX idx_agent_loop_runs_created ON agent_loop_runs(created_at DESC);
...
CREATE TRIGGER update_intent_leads_updated_at BEFORE UPDATE ON intent_leads
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_deal_matches_updated_at BEFORE UPDATE ON deal_matches
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_deal_match_scripts_updated_at BEFORE UPDATE ON deal_match_scripts
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
